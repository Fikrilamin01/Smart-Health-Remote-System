...
public class SendPrescriptionController {
    ...
    public String getPrescriptionForm(@PathVariable String patientId, Model model) throws ExecutionException, InterruptedException {
    ...
    public String submitPrescriptionForm(@RequestParam(value = "patientId") String patientId,
        ...
        Prescription prescription1 = new Prescription(doctorId, medicineList, prescription, diagnosisAilment);
